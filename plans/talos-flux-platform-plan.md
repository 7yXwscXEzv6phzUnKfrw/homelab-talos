...
| Internal Gateway IP | `192.168.90.101` |
| Talos | `v1.13.6` |
| Kubernetes | `v1.35.6` |
| Talhelper | `v3.1.13` |
| Cilium | `v1.19.5` |
...
environment and the existing `192.168.90.100-110` pool is proven.
...
- Create an HTTPRoute for `echo.lab.supermorphic.com` with the internal DNS
  audience annotation.
- Verify Pi-hole publishes `192.168.90.101` and HTTPS presents the wildcard
  certificate.
...
- Pi-hole resolves the echo hostname to `192.168.90.101`.
